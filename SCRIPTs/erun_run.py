# run_erun.py - 4 mpjobs
from __future__ import print_function
# erun activity does not works well if:
#   - machine does not have an exciter model
...
if My['STUDYTYPE'].upper()=='OPEN_CIRCUIT':
   psspy.estr_open_circuit_test(Genx,erunvdelta,outfile)
else:
   psspy.estr_response_ratio_test(Genx, erunpf,0,[],[],[],outfile)
psspy.erun(My['SIMTIME'],99,9,0)
